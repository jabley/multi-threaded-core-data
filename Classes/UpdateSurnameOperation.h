...
/**
 ThreadedCoreDataOperation that will update the surname of a specified Person entity.
 */
@interface UpdateSurnameOperation : ThreadedCoreDataOperation {
